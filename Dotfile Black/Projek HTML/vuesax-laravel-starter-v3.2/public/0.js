  ...
  methods: {
    ...
    elapsedTime: function elapsedTime(startTime) {
      ...
      if (years > 0) {
        ...
        return seconds + (seconds > 1 ? "".concat(seconds, " beberapa detik yang lalu") : 'baru saja');
      }
...
var render = function() {
  ...
  return _c(
    "footer",
    { staticClass: "the-footer flex-wrap justify-end", class: _vm.classes },
    [
      _c("span", [
        ...
        _c(
          "a",
          {
            attrs: {
              href:
                "https://instagram.com/maulanaakurniaa",
              target: "_blank",
              rel: "nofollow"
            }
          },
          [_vm._v("Maulana Kurnia")]
        ),
